      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <!-- form starts -->
            <form action="{{url('/uploadfood')}}" method="post" enctype="multipart/form-data" class="form-horizontal align-items-center" style="width:40%" >
                ...
                <!-- Form Name -->
                <legend>Food Items to Add</legend>
            ...
            <div class="container-fluid"> 
              ...
              <table class="table table-hover table-striped table-bordered table-dark table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <td><img src="/food_images/{{$data->image}}" alt=""></td>
                            <td>
                              <a type="button" class="btn btn-info btn-sm" href="{{url('/editmenu', $data->id)}}" ><i class="fa fa-edit"></i>Edit</a>
                              <a type="button" class="btn btn-danger btn-sm" href="{{url('/deletemenu', $data->id)}}" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash"></i>Delete</a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
